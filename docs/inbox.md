...
- [ ] **后续散文候选批次** — 候选范围已由 docs/plan-knowledge-correctness.md 移入 docs/plan-corpus-candidate-batches.md，按组合新增、组合增量与技能释义、建设与资源、排班与换班、用人与布局五批实施；候选共 36 个来源对象（包含罗德岛基建建设其余建设主题与经验/搓玉），按段落取增量，另有 20 篇已界定不整篇导入。第一批 7 篇组合新增已采用，落入既有两篇组合正文，补齐六节事实关联并修正相关中枢机制；第二批 12 篇组合增量与技能释义已采用，按增量补入三篇组合正文与一篇结算机制文，并新增「莱茵生命阵营」小节；当前 22 篇正式正文 / 175 检索块，来源、逐篇评估、主代理复核与不采用理由见 docs/plan-corpus-candidate-batches-notes.md。各批临时工作副本随批清理，后续按实际所需重新取材。第三至五批尚未实施，原因是批次范围，尚未逐篇审阅的候选不写成质量拒绝；继续按批交只读子代理评估，采用仍走写作与术语 spec 及 corpus-addition skill。 — 2026-09-19 — 前两批完成，后三批待实施
