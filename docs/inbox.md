...
- [ ] **后续散文候选批次** — 候选范围已由 docs/plan-knowledge-correctness.md 移入 docs/plan-corpus-candidate-batches.md，按组合新增、组合增量与技能释义、建设与资源、排班与换班、用人与布局五批实施；候选原登记 36 个来源对象，按第三批实际篇目核准为 35 个（包含罗德岛基建建设其余建设主题与经验/搓玉），按段落取增量，另有 20 篇已界定不整篇导入。第一批 7 篇组合新增已采用，落入既有两篇组合正文，补齐六节事实关联并修正相关中枢机制；第二批 12 篇组合增量与技能释义已采用，按增量补入三篇组合正文与一篇结算机制文，并新增「莱茵生命阵营」小节；第三批 5 篇来源（干员升级与模组消耗、库存与爆仓、信用、公招与凭证、罗德岛基建建设其余建设主题、搓玉，其中「信用、公招与凭证」为同一篇）已完成采用、联合审阅与验证——建设通则扩为全设施建造消耗表，基建物流链补爆仓口径与搓玉理智成本，会客室补信用产出、办公室补联络次数上限；其中干员升级与模组消耗未采用（练度消耗属战斗养成，其钱书比与产出对照归第五批）。第四批换班操作 5 篇（队列轮换、自动轮换、定时换班、动态换班、错班轮换）已完成采用、联合审阅与验证——新增 base/机制-排班与轮换.md（轮休工休锚点、三组三班结构、班制核算、单站班型与中枢轮换）与 guides/换班操作.md（换班方式、队列轮换、自动轮换、定时换班、动态换班），队列、休整与锁定的机制边界补入 base/机制-基建总览.md；同批的「可露希尔基建终端排班机制」未采用（第三方工具生成策略、无游戏机制增量、与干员「可露希尔」重名），MAA/mower 专有操作同样不采用。当前 24 篇正式正文 / 191 检索块，来源、逐篇评估、主代理复核与不采用理由见 docs/plan-corpus-candidate-batches-notes.md。各批临时工作副本随批清理，后续按实际所需重新取材。第五批尚未实施，原因是批次范围，尚未逐篇审阅的候选不写成质量拒绝；继续按批交只读子代理评估，采用仍走写作与术语 spec 及 corpus-addition skill。 — 2026-09-19 — 前四批完成，第五批待实施
