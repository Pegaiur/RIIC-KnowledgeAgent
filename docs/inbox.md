...
- [ ] **后续散文候选批次** — docs/plan-corpus-candidate-batches.md 承接原知识正确性计划的五批候选，共 35 篇来源（原 36 个对象按实际文件核准），另有 20 篇按需取增量、不整篇导入。前四批已完成验收，当前 24 篇正式正文 / 191 检索块，来源、采用与未决项见对应 notes。第五批明确覆盖练卡取向、布局总表、布局选择、无人机使用、钱书价值与价值比例，以及前批转入的基建投资、长期布局和钱书产出比较；逐篇评估后决定增量，不因旧计划的批次边界或本地尚无布局目录排除主题。先完成同计划的散文分类整理，再按目标路径落位第五批正文；采用与清理沿用写作/术语 spec 和 corpus-addition skill。 — 2026-09-19 — 前四批完成，分类整理已验收，第五批另批验收
