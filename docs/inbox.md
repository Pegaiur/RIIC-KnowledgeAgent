...
- [ ] **后续散文候选批次** — 候选范围沿用 docs/plan-knowledge-correctness.md「后续候选」；孑、社群的意义、新组合、建设资源、排班与布局等另定具体采用批次，已有正文只补增量。固定来源版本与已采用内容见对应 notes，临时工作副本已清理，后续按实际所需重新取材。 — 2026-09-19 — 保留候选，未扩大本轮交付
