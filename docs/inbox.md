...
- [ ] **关键词目录重复文本过多，需优化** — 关键词目录随每次查询注入 system prompt，重复说明文本占比过高、注入体积偏大，需评估压缩呈现；债务细节与重启条件已落在代码 TODO(tech-debt) IDX-1，此处只留结论与路由。 — 2026-09-13 — 待评估，可能作为 docs/plan-index-and-tags.md 后续条目或独立 plan
