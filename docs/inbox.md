...
- [ ] **facts 子串对（短→长全量返回）** — 登记歧义.md第一节 31 组「短名 ⊂ 长名」，查询词恰为短名时返回短名与全部长名；短→长单向、无新增成员则不产出路径、不做消歧或反问；就地二次修订 [ADR-010](adr/ADR-010-facts-alias-disambiguation.md)，实施见 [facts 子串对登记计划](plan-facts-substring-pairs.md)。本轮仅落地文档，未开始编码、未启动付费运行。 — 2026-09-10
