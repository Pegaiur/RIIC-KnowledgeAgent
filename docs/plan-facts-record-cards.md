...
- [ ] 规范化实体、人工覆盖和 RecordCard 投影类型落地
- [ ] 名册及技能分片解析器完成，原文 100% 消费并可回渲染
- [ ] 机械字段逐字段/集合 0 差异核对完成
- [ ] 167 条替换关系全部唯一闭合，同名升级回归通过
- [ ] 办公室事实批次与人工优化批次完成
- [ ] 发电站事实批次与人工优化批次完成
- [ ] 会客室事实批次与人工优化批次完成
- [ ] 加工站事实批次与人工优化批次完成
...
- [ ] 训练室事实批次与人工优化批次完成
- [ ] 制造站事实批次与人工优化批次完成
- [ ] 28 个干员组、193 条成员关系、5 个技能类别、82 个等价组完成精确拼装
- [ ] `raw` / `curated` 双模式及优化失效检测完成
- [ ] 多设施 `room + termQuery` 串线修复，查询序列化按命中范围裁剪
