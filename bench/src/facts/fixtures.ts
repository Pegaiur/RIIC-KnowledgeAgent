 ...
 *
 * 机械字段与 references 名册原行 0 差异（verifyMechanicalCard 覆盖）；
 * 语义字段（aliases/skillGroups/skills/notes）为人工从 references 转录的基准值，
 * 供后续 LLM 转录 + 人工抽检对照。
 *
...
/** 标杆条目：记录卡 + 出处（名册.md 原行，供逐字 0 差异断言） */
...
export const FACTS_FIXTURES: FactsFixture[] = [
  {
    // 单设施、无组
    source: '- 刻俄柏 | ☆6 | 术师 | 制造站',
    card: {
