 ...
 *
 * 来源：docs/archive/plan-index-and-tags.md 第 2 步及其关键词盘点（0.1~0.6）。
 */
...
const MECHANISMS: readonly CatalogTermEntry[] = [
  ...
  { term: '队列轮换、快速切换、进驻顺序', provides: '队列切换、干员休整与锁定编辑的机制边界', entry: 'R：机制-基建总览、换班操作', scope: '机制事实以基建总览为准，动作与步骤见换班操作' },
  { term: '排班、换班、轮休、班制、替班', provides: '排班结构、班制核算与换班方式', entry: 'R：机制-排班与轮换、换班操作', scope: '班制与轮休核算以正文前提为准，不输出全局最优排班' },
  { term: '新手培养、最低目标、散件、组合核心、挂件', provides: '选择理由和适用边界', entry: 'R：新手培养、高效率散件及组合 guides', scope: '选择理由不构成固定培养目标；培养取向与回本口径见新手培养' },
  { term: '布局、布局代号、二发电与三发电、钱书产出比较', provides: '布局构成、电力约束与按需求选择', entry: 'R：布局选择、机制-设施建造与升级、基建物流链', scope: '不宣称全局最优布局；产出比较须统一时段、单位与钱书价值假设' },
  { term: '无人机去向、加速贸易站、等效效率', provides: '无人机投向原则与贸易站优先级', entry: 'R：无人机使用、机制-发电站', scope: '长期排序须固定练度、订单分布与赤金平衡；单次库存充足时另按订单产值比较' },
]
