...
export const MANUFACTURING_CURATIONS: CurationBatch = {
  ...
  operators: [
    ...
    // 来源：knowledge/guides/制造站组合.md「莱茵科技：制造技能协作与阵营计数边界」
    {
      operatorId: '多萝西',
      notes: '本卡属「莱茵科技」：重要增强成员为淬羽赫默、娜斯提（均精二）；其他持莱茵科技类技能的成员按解锁档加入；莱茵生命阵营成员不等同于本组成员。',
    },
    // 来源：knowledge/guides/制造站组合.md「水月标准化组：技能成员条件与中枢分工」；knowledge/raw/技能-制造站.md「水月 ☆6 · 特种」
    {
      operatorId: '水月',
    ...
    // 来源：knowledge/guides/制造站组合.md「赤金工艺组：同站技能成员与贵金属配方」「红松骑士团组：中枢与经验制造分工」
    {
      operatorId: '砾',
