...
export const CONTROL_CURATIONS: CurationBatch = {
  ...
  grants: [],
  operators: [
    // 来源：knowledge/guides/组合/贸易站组合.md「人间烟火组：跨设施资源链与贸易用途」；knowledge/guides/组合/跨设施组合.md「感知信息组：资源用途与跨设施分工」
    {
      operatorId: '令',
    ...
    // 来源：knowledge/guides/组合/制造站组合.md「红松骑士团组：中枢与经验制造分工」
    {
      operatorId: '焰尾',
      notes: '本卡精二进控制中枢，支持「红松骑士团组」的作战记录制造；薇薇安娜精二可进一步增强，制造成员按持有情况安排并比较受益人数。',
    },
    // 来源：knowledge/guides/组合/跨设施组合.md「龙门中枢组：中枢成员协作与制造站加成」
    {
      operatorId: '陈',
