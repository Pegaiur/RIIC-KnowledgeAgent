...
const cases = [
  ['F01', '发电站无人机的充能机制是什么？充能是否会受到发电站干员的影响？', 'base/机制-发电站.md', '无人机充能速度：单站加成与全站合计'],
  ['F02', '制造站受干员技能加成的效率计算规则是怎样的？', 'base/机制-制造站.md', '生产力、心情消耗与已节省计时'],
  ['F03', '贸易站订单的处理机制与订单上限受什么影响？', 'base/机制-贸易站.md', '订单获取效率、处理时间与订单上限'],
  ['F04', '会客室线索获取与线索交流的机制要点是什么？', 'base/机制-会客室.md', '线索交流、传递与回收的条件'],
  ['F05', '办公室的联络速度由什么决定？哪些干员能提供联络速度加成？', 'base/机制-办公室.md', '联络计时、速度加成与间隔换算'],
  ['F06', '控制中枢的加成如何作用于其他基建设施？', 'base/机制-控制中枢.md', '全局心情减免的人数项与设施范围'],
  ['F07', '干员心情消耗与宿舍恢复的规则是什么？', 'base/机制-宿舍.md', '心情恢复公式：宿舍等级、实际氛围与技能'],
  ['F08', '排班轮换策略中常用的三队轮换模式是如何运作的？', 'base/机制-心情与工休.md', '组合共同班次、宿舍容量与轮换约束'],
  ['F09', '干员练度与技能等级对基建技能效果的影响规则是什么？', 'base/机制-技能解锁与练度.md', '干员练度、技能解锁档与低星等级门槛'],
  ['F10', 'buff 叠加模型中，不同类型的基建技能效果是如何叠加的？', 'base/机制-后勤技能结算.md', '同种效果取最高、加成叠加与技能替换'],
] as const
